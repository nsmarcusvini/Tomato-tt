-- Criando Banco de Dados cultivo_tomato --
create database cultivo_tomato;

-- Selecionando Banco de Dados cultivo_tomato --
use cultivo_tomato;

-- Criando Tabela Cadastro T1, com os campos: idCliente, nome, contato e cidade --
...
-- Criando Tabela Usuários T2, com os campos: idUsuario, nome, email, senha, fkFazenda e fkCadastro --
...
-- Criando Tabela Fazenda T3, com os campos: idFazenda, tipoSolo, tipoTomate, tamanhoFazenda,dtConsumo e consumoAgua --
...
-- Criando Tabela Dados Históricos T4, com os campos: idDados, dtUmidade, medidasUmidade, dtTemperatura, medidaTemperatura, statusSensor, fkSensor --
...
-- Criando Tabela Sensor T5, com os campos: idSensor, descricao, localSensor, fkFazenda -- 
create table sensor (
...
insert into usuario (nome,email,senha,fkCadastro,fkFazenda) values
('Bruno Tavares','bruno.tavares@bandtec.com.br','1234567890',1,1),
('Marcus Vinicius','marcus@bandtec.com.br','1010101010',2,2),
('Breno Padovani','breno@bandtec.com.br','2020202020',3,3),
('Igor Quintanilha','igor@bandtec.com.br','3030303030',4,4),
('Juliana Ju','juliana@bandtec.com.br','4040404040',5,5),
('Kamila Santos','kamila@bandtec.com.br','5050505050',6,6),
('Carlos Felix','carlos@bandtec.com.br','6060606060',1,1),
('Marise Machine','marise@bandtec.com.br','7070707070',2,2),
('Vivian Dados','vivian@bandtec.com.br','8080808080',3,3),
('Friza Maioral','friza@bandtec.com.br','9090909090',4,4),
('Betina','betina@bandtec.com,br','1212121212',5,5),
('Regina','regina@bandtec.com.br','2121212121',6,6);

-- Inserindo dados na tabela fazenda -- 
insert into fazenda (tipoSolo,tipoTomate,tamanhoFazenda,dtConsumo,consumoAgua) values
...
select * from usuario join cadastro on usuario.fkCadastro = idUsuario
					  join fazenda on usuario.fkFazenda = idFazenda;                      